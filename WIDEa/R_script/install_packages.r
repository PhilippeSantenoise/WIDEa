...
if ("arrangements" %in% rownames(installed.packages()) == F) {
   install.packages("arrangements", Sys.getenv("R_LIBS_USER"), repos = "http://cran.case.edu")
}

if ("car" %in% rownames(installed.packages()) == F) {
