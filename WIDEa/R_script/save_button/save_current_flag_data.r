...
#
#
# Description : function used to create/update flag data. If the "with flags" radio button (left panel)
#               is not checked, then a new flag data is created, else the current flag data 
#               (e_current_flag$coord created from the f_create_current_flag_data function) is added to 
#               the previous (existing) flag data (e_data$flag).
#
...
# s_action: value of "action" radio button in the Flag tab (2 values: "add_flag", "replace_qc")
# df_previous_flag: flag data saved in the e_data environment (e_data$flag). This input is NULL if the "with flags" box is not  
#                   checked (left panel).
# df_current_flag: flag data saved in the e_current_flag environment (e_current_flag$coord). 
# df_all: data saved in o_plot reactive value (o_plot$data). This input is only used for the temporal data type (default = NULL). 
# s_id_var: ID variable name (input only used for the normal/IR data type, default = NA)
# s_x_var: X variable name (input only used for the temporal data type, default = NA) 
# i_qc: value of "qc" radio button in the Flag tab (input only used for the temporal/IR data type, default = NA)
# s_comment: comment added from the corresponding field in the Flag tab (input only used for the temporal/IR data type, default = "")
