...
f_create_click_info <- function (s_data_type = "ir", s_action = "add_flag", s_dim_num = NULL, v_xy_flag = NULL, b_z_flag = F, s_flag_name = NA, e_data = NULL, o_click_ev, o_parameter = NULL, o_plot, o_cond) {
