...
f_ui <- function() {
	...
	o_ui <- fluidPage(theme = shinytheme("flatly"),
		...
		div(
			...
			tags$head(tags$style(HTML(".del {background-color: #F8412C; border: none; color: #FFFFFF; width: 25px; padding: 2px; font-size: 85%;}
			...
			tags$head(tags$style(HTML(".expand {border: none; width: 25px; padding: 2px; font-size: 85%;}"))),
			...
			wellPanel(id = "lpanel",
				...
				div(style = paste0("position: absolute; top: 11.15em; left: ", 15.85 + as.vector(df_UI_param[which(df_UI_param$Parameters == "lp_button_gap"), s_OS_name]), "em;"), actionButton('edit_dopt1_button', NULL, icon = icon("pen"), class = "expand")),
				...
				div(style = paste0("position: absolute; top: 19.64em; left: ", 15.85 + as.vector(df_UI_param[which(df_UI_param$Parameters == "lp_button_gap"), s_OS_name]), "em;"), disabled(actionButton('edit_dopt2_button', NULL, icon = icon("pen"), class = "expand"))),
				...
				div(style = paste0("position: absolute; top: 33.97em; left: ", 15.85 + as.vector(df_UI_param[which(df_UI_param$Parameters == "lp_button_gap"), s_OS_name]), "em;"), disabled(actionButton('expand_list1_button', NULL, icon = icon("expand-alt"), class = "expand"))),
				div(style = "position: absolute; top: 33.7em; left: 1.25em;", strong("Variable name:")),
				div(style = "position: absolute; top: 35.56em; left: 1.25em;", disabled(selectizeInput("vname", NULL, choices = " ", width = paste0(as.vector(df_UI_param[which(df_UI_param$Parameters == "lp_text_input"), s_OS_name]), "px"), options = list(maxOptions = 9999)))),
				...
				div(style = paste0("position: absolute; top: 46.26em; left: ", 13.85 + as.vector(df_UI_param[which(df_UI_param$Parameters == "lp_button_gap"), s_OS_name]), "em;"), disabled(actionButton('expand_list2_button', NULL, icon = icon("expand-alt"), class = "expand"))),
				div(style = paste0("position: absolute; top: 46.26em; left: ", 15.85 + as.vector(df_UI_param[which(df_UI_param$Parameters == "lp_button_gap"), s_OS_name]), "em;"), disabled(actionButton('del1_button', NULL, icon = icon("trash-alt"), class = "del"))),
				...
				div(style = paste0("position: absolute; top: 55.6em; left: ", 15.85 + as.vector(df_UI_param[which(df_UI_param$Parameters == "lp_button_gap"), s_OS_name]), "em;"), disabled(actionButton('expand1_button', NULL, icon = icon("expand-alt"), class = "expand"))),
				...
				div(style = paste0("position: absolute; top: 90.36em; left: ", 15.85 + as.vector(df_UI_param[which(df_UI_param$Parameters == "lp_button_gap"), s_OS_name]), "em;"), disabled(actionButton('edit_dopt3_button', NULL, icon = icon("pen"), class = "expand"))),
				...
				div(style = paste0("position: absolute; top: 104.51em; left: ", 15.85 + as.vector(df_UI_param[which(df_UI_param$Parameters == "lp_button_gap"), s_OS_name]), "em;"), disabled(actionButton('expand_list3_button', NULL, icon = icon("expand-alt"), class = "expand"))),
				...
				div(style = paste0("position: absolute; top: 109.9em; left: ", 13.85 + as.vector(df_UI_param[which(df_UI_param$Parameters == "lp_button_gap"), s_OS_name]), "em;"), disabled(actionButton('expand_list4_button', NULL, icon = icon("expand-alt"), class = "expand"))),
				div(style = paste0("position: absolute; top: 109.9em; left: ", 15.85 + as.vector(df_UI_param[which(df_UI_param$Parameters == "lp_button_gap"), s_OS_name]), "em;"), disabled(actionButton('del2_button', NULL, icon = icon("trash-alt"), class = "del"))),
				...
				div(style = paste0("position: absolute; top: 117.01em; left: ", 13.85 + as.vector(df_UI_param[which(df_UI_param$Parameters == "lp_button_gap"), s_OS_name]), "em;"), disabled(actionButton('expand_list5_button', NULL, icon = icon("expand-alt"), class = "expand"))),
				div(style = paste0("position: absolute; top: 117.01em; left: ", 15.85 + as.vector(df_UI_param[which(df_UI_param$Parameters == "lp_button_gap"), s_OS_name]), "em;"), disabled(actionButton('del3_button', NULL, icon = icon("trash-alt"), class = "del"))),
				...
				div(style = paste0("position: absolute; top: 121.6em; left: ", 15.85 + as.vector(df_UI_param[which(df_UI_param$Parameters == "lp_button_gap"), s_OS_name]), "em;"), disabled(actionButton('expand2_button', NULL, icon = icon("expand-alt"), class = "expand"))),
				...
				div(style = paste0("position: absolute; top: 130.66em; left: ", 13.85 + as.vector(df_UI_param[which(df_UI_param$Parameters == "lp_button_gap"), s_OS_name]), "em;"), disabled(actionButton('expand_list6_button', NULL, icon = icon("expand-alt"), class = "expand"))),
				div(style = paste0("position: absolute; top: 130.66em; left: ", 15.85 + as.vector(df_UI_param[which(df_UI_param$Parameters == "lp_button_gap"), s_OS_name]), "em;"), disabled(actionButton('del4_button', NULL, icon = icon("trash-alt"), class = "del"))),
				...
				div(style = paste0("position: absolute; top: 135.45em; left: ", 15.85 + as.vector(df_UI_param[which(df_UI_param$Parameters == "lp_button_gap"), s_OS_name]), "em;"), disabled(actionButton('expand3_button', NULL, icon = icon("expand-alt"), class = "expand"))),
				...
				div(style = paste0("position: absolute; top: 141.41em; left: ", 13.85 + as.vector(df_UI_param[which(df_UI_param$Parameters == "lp_button_gap"), s_OS_name]), "em;"), disabled(actionButton('expand_list7_button', NULL, icon = icon("expand-alt"), class = "expand"))),
				div(style = paste0("position: absolute; top: 141.41em; left: ", 15.85 + as.vector(df_UI_param[which(df_UI_param$Parameters == "lp_button_gap"), s_OS_name]), "em;"), disabled(actionButton('del5_button', NULL, icon = icon("trash-alt"), class = "del"))),
				...
				div(style = paste0("position: absolute; top: 146.2em; left: ", 15.85 + as.vector(df_UI_param[which(df_UI_param$Parameters == "lp_button_gap"), s_OS_name]), "em;"), disabled(actionButton('expand4_button', NULL, icon = icon("expand-alt"), class = "expand"))),
				...
				div(style = paste0("position: absolute; top: 154.34em; left: ", 13.85 + as.vector(df_UI_param[which(df_UI_param$Parameters == "lp_button_gap"), s_OS_name]), "em;"), disabled(actionButton('expand_list8_button', NULL, icon = icon("expand-alt"), class = "expand"))),
				div(style = paste0("position: absolute; top: 154.34em; left: ", 15.85 + as.vector(df_UI_param[which(df_UI_param$Parameters == "lp_button_gap"), s_OS_name]), "em;"), disabled(actionButton('del6_button', NULL, icon = icon("trash-alt"), class = "del"))),
				...
				div(style = paste0("position: absolute; top: 158.96em; left: ", 15.85 + as.vector(df_UI_param[which(df_UI_param$Parameters == "lp_button_gap"), s_OS_name]), "em;"), disabled(actionButton('expand5_button', NULL, icon = icon("expand-alt"), class = "expand"))),
				...
				div(style = paste0("position: absolute; top: 168.71em; left: ", 13.85 + as.vector(df_UI_param[which(df_UI_param$Parameters == "lp_button_gap"), s_OS_name]), "em;"), disabled(actionButton('expand_list9_button', NULL, icon = icon("expand-alt"), class = "expand"))),
				div(style = paste0("position: absolute; top: 168.71em; left: ", 15.85 + as.vector(df_UI_param[which(df_UI_param$Parameters == "lp_button_gap"), s_OS_name]), "em;"), disabled(actionButton('del7_button', NULL, icon = icon("trash-alt"), class = "del"))),
